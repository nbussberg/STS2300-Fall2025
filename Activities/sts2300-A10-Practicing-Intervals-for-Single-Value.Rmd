...
**To have this activity marked as "Complete"**: You need to complete **either** Part 1 (interval for proportion) or Part 2 (interval for mean). I encourage you to attempt both (you will be responsible for both on homework), both only one is required for this activity.
