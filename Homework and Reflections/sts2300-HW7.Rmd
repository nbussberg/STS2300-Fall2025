...
# For this Homework, you only need to complete 1 of the 2 parts. 
...
```{r, echo = FALSE}
rain <- read.csv("https://raw.githubusercontent.com/nbussberg/STS2300-Fall2025/refs/heads/main/Data/rainfall.csv")
```
