...
```{r}
hedgehogs <- read.csv("https://raw.githubusercontent.com/nbussberg/STS2300-Fall2025/refs/heads/main/Data/hedgehogs.csv") |> 
  filter(Sex != "Unknown") |> 
...
2. I've written code below to summarize the data for you. Use this summarized data to create **graph A**. Pay attention to each of the following when making your graph:
